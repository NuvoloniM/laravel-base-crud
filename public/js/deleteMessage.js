...
var deleteBtn = document.querySelectorAll('.delete-form'); // ottenuto l'array lo ciclo per assegnare a tutti gli elementi l'evento
...
deleteBtn.forEach(function (element) {
  ...
  var title = element.getAttribute('data-name'); // aggiungo l'evento ma non al click, al submit

  element.addEventListener('submit', function (e) {
    // con prevent Default evito che al click del submit btn non ricarichi la pagina
    e.preventDefault(); // creo allert che mi chiedsa la conferma 

    var accept = confirm("Are you sure? You want to delete: ".concat(title, " ")); // se l'allert confirm  mi ritrona true allora faccio partire il submit. Cioè l'evento che si attiva quando clicco il btn in un form 
...
module.exports = __webpack_require__(/*! /Users/matteonuvoloni/Desktop/Boolean/Laravell/laravel-base-crud/resources/js/deleteMessage.js */"./resources/js/deleteMessage.js");
